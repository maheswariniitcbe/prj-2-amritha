(function() {
  var module = angular.module("angular-google-maps-example", ["ngRoute", "google-maps"]);
  module.config(function($routeProvider) {
    $routeProvider
      .when('/', {
        templateUrl: "app.html",
        controller: 'ExampleController',
        resolve: ExampleController.resolve,


      });
  });

  module.factory('myDataService', function($http, $q) {
    var svc = {};
...
var ExampleController = module.controller('ExampleController', function($scope, $timeout, $log, $http, myInfo, myMarkers) {
  ...
  angular.extend($scope, {
    map: {
      ...
      clusterOptions: {
        ...
        imageExtension: 'png',
        imagePath: 'http://localhost:3000/example/cluster',
        imageSizes: [72]
      },
      clickedMarker: {
